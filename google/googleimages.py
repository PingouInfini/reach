...
def treatment(user):
    ...
    # check_fileinfo(utils.get_directory_from_property('GoogleImages', 'googleimages.imagesdirectory') + user)


def get_metadata_from_username(user):
    limit = utils.get_int_from_property('GoogleImages', 'googleimages.limit')
